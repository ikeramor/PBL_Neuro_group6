...
def main():
    ...
    coupling_file = Path("/home/jovyan/Desktop/PBL_Neuro/postprocessing/SC-FC_Coupling/network_SC_coupling.csv")
    ...
    if not coupling_file.exists():
        coupling_file = Path("network_SC_coupling.csv")
        if not coupling_file.exists():
            coupling_file = Path("../postprocessing/SC-FC_Coupling/network_SC_coupling.csv")
            if not coupling_file.exists():
                coupling_file = Path("Desktop/PBL_Neuro/postprocessing/SC-FC_Coupling/network_SC_coupling.csv")
